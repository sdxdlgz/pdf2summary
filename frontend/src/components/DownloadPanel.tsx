...
const FILE_TYPES: FileTypeInfo[] = [
  ...
  { type: 'bilingual_md', label: '中文翻译 Markdown', icon: '🔄', extension: '.md' },
  { type: 'bilingual_docx', label: '中文翻译 DOCX', icon: '📋', extension: '.docx' },
  { type: 'summary', label: '中文总结', icon: '📊', extension: '.md' },
];
